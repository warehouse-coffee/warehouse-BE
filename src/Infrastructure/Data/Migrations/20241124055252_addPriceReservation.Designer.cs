...
namespace warehouse_BE.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241124055252_addPriceReservation")]
    partial class addPriceReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("warehouse_BE.Domain.Entities.Configuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("warehouse_BE.Domain.Entities.InventoryOutbound", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("ExpectedOutboundDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("warehouse_BE.Domain.Entities.OutboundDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("InventoryOutboundId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("InventoryOutboundId");
            ...
            modelBuilder.Entity("warehouse_BE.Domain.Entities.OutboundDetail", b =>
                {
                    b.HasOne("warehouse_BE.Domain.Entities.InventoryOutbound", "InventoryOutbound")
                        .WithMany("OutboundDetails")
                        .HasForeignKey("InventoryOutboundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("InventoryOutbound");
